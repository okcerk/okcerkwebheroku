...
const homepageTitle = "Okcerk.com - Cartoons and comics by Andres Marc";
...
const getArtwork = ({ match }) => {
  ...
  if (!config) {
    return withTitle(<HomePage />, homepageTitle);
  }
      ...
      <Router history={history}>
        <div style={style.body}>
          ...
          <Route
            ...
            path="/ink"
            render={() =>
              withTitle(<InkPage />, titleWithEnding("Ink artwork"))
            }
          />
          <Route
            name="escuadron37"
          ...
          <Route
            ...
            path="/inktober"
            render={() =>
              withTitle(<InktoberPage />, titleWithEnding("Inktober"))
            }
          />
          <Route
            name="inktober2018"
